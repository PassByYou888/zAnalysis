...
uses
  ...
  CoreClasses, DoStatusIO, PascalStrings, UnicodeMixedLib,
  MemoryRaster, zDrawEngine,
  Geometry2DUnit,
  zDrawEngineInterface_SlowFMX, PictureViewerInterface;
...
var
  r: TMemoryRaster;
begin
  r := NewRasterFromFile(TListBoxItem(Sender).TagString);
  r.BlendBlack;
  Viewer.Clear;
